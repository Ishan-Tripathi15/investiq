...
import { buildScenarioEngine, calculateFinancialQuality, calculateStockStats, type FinancialPeriodInput, type PricePoint } from '@investiq/domain';
...
export default function Intelligence() {
  ...
  async function analyze() {
    ...
    try {
      ...
      setPoints([]); setFundamentals(null); setSource(null);
